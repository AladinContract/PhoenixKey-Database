...
public class KeyServiceImpl implements KeyService {
    ...
    public KeyRotationResponse rotate(KeyRotateRequest request) {
        ...
        // 6. Reset seedExportedAt (spec §9.5) — rotate xong, dashboard banner
        // cảnh báo Seed Export tự ẩn. Save trong cùng @Transactional —
        // chỉ commit khi toàn bộ flow rotate (Cardano + DB key swap) thành công.
        if (user.getSeedExportedAt() != null) {
            user.setSeedExportedAt(null);
